...
export default function PurlinsLeftDH({material} : {material : THREE.Material}) {
    ...
    const PURLINLEFT = () => {
        useLayoutEffect(() => {
            ...
            const {hP, eavesHeight, coveringLengthDH, roofInclineRad, width, length, pillars} = requiredValues;
