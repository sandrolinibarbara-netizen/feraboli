...
export default function Struts({material} : {material : THREE.Material}) {
    ...
    const PILLARS = () => {
        ...
        return(
            <instancedUniformsMesh ref={ref} args={[strutsDGeometry, material, (effPillars * (requiredValues.length / requiredValues.interaxleLength)) + effPillars]}></instancedUniformsMesh>
        )
    }
